      ...
      const { currentUser } = useContext(AuthContext);
            ...
            const handleFormSubmit = async (e) => {
                ...
                try {
                  ...
                  navigate("/dashboard/governmentAgencies"); // Redirect after form submission
                } catch (error) {
                        ...
                        onSubmit={handleFormSubmit}>
                            ...
                            <div className="flex flex-col md:flex-row gap-8">
                                <div className="flex-1">
                                    ...
                                    <label className="block mb-1 mt-3 text-sm font-medium text-white">Application Link</label>
                                    <input
                                        type="url"
                                        name="application_link"
                                        className="w-full p-2 bg-gray-600 rounded-md outline-none text-white placeholder:text-gray-200"
                                        value={newDetails.application_link}
                                ...
                                <div className='flex-1'>
                                    ...
                                    <label className="block mb-1 mt-3 text-sm font-medium text-white">Website/Social Media URL</label>
                                    <input
                                        type="url"
                                        name="website"
                                        className="w-full p-2 bg-gray-600 rounded-md outline-none text-white placeholder:text-gray-200"
                                    ...
                                    <div className="flex justify-end">
                                        <button
                                            type="submit"
                                            className="mt-20 bg-blue-300 text-black font-bold py-2 px-4 rounded-md hover:bg-blue-600 transition duration-300">
                                            sub
                                        </button>
                                    </div>
                                </div>
...
export default GovernmentAgenciesB;