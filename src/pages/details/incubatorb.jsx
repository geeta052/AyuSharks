      ...
      const { currentUser } = useContext(AuthContext);
            ...
            const handleFormSubmit = async (e) => {
                ...
                try {
                  ...
                  navigate("/details/incubatorc"); // Redirect after form submission
                } catch (error) {
                ...
                <div className="flex justify-center items-center min-h-screen bg-gray-900">
                        ...
                        onSubmit={handleFormSubmit}>
                            ...
                            onChange={handleChange}>
                                    ...
                                    <label className="block mb-1 mt-3 text-sm font-medium text-white">Incubation Center Location</label>
                                    <input
                                        type="text"
                                        name="incubation_center_location"
                                        className="w-full p-2 bg-gray-600 rounded-md outline-none text-white placeholder:text-gray-200"
                                        value={newDetails.incubation_center_location}
                                        onChange={handleChange}
                                        required />
