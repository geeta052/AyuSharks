      ...
      const { currentUser } = useContext(AuthContext);
            ...
            const handleFormSubmit = async (e) => {
                ...
                try {
                  ...
                  navigate("/details/acceleratorc"); // Redirect after form submission
                } catch (error) {
            ...
            onSubmit={handleFormSubmit}>
                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className='flex-1'>
                        ...
                        <label className="block mb-1 mt-3 text-sm font-medium text-white">Accelerator Center Location</label>
                        <input
                            type="text"
                            name="accelerator_center_location"
                            className="w-full p-2 bg-gray-600 rounded-md outline-none text-white placeholder:text-gray-200"
                            value={newDetails.accelerator_center_location}
                            onChange={handleChange}
                            required />
